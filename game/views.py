...
def result(request):
	...
	solutions = {
		1:"COPYCAT:1, DETECTIVE: 10,  COOPERATE :4, ALL CHEAT:10 <br> NO OF ROUNDS PER MATCH: 4 <br> In the first round of the first match detective,cooperate and copy cat will have same score (18) as all of have same moves and all cheat will exploit every other character gaining a total of 15X3=45. <br> Second round: Now cooperates will get exploited by all cheats as well as detectives(2nd move is cheat) reducing its score by 20 points. A Cooperate gets 4X2 =8 points by cooperating by other three cooperates and a copy cat. Total=6  <br> Now all cheat can exploit only cooperates incrementing its score by 4X3=12 making it 57. Detective gets 5X3 =15 points by cheating with copy cat and cooperates. Copy cat gets 4X2=8 points from cooperates and (-1)X10 from detectives making it a total of 16. <br>Inspecting further rounds we notice that cooperates are the least scorers and thus will get eliminated first. <br>The scenario will be the same when no of rounds is less. Therefore, making the result as: <br>  All cheat>copycat>detective>cooperate.",
		2:"Always Cheat = 10, Always Cooperate = 4, Detective = 10, Copycat = 4.<br>If number of rounds > 6 (=30)<br>The winner in this case is = Copycat > Detective > Always Cheat > Cooperate.<br>Explanation: <br>For rounds > 4, Cooperate and Detective behave similarly. So, we need to consider rounds < 4. If we have 4 Cooperates, then the copycats will be able to exploit them less than Detectives. That’s because for the remaining of the 26 moves will make them gain +3 against the copycats earning +2 from the always cooperates.<br>After the round 1, 3 Always cooperates will get removed. So, with the remaining 1 Always Cooperate, the extent of exploitation begins to fall for Detectives. Also, now the first 4 moves of the Detective begin to take importance, that is Co Ch Co Co, which make them vulnerable to Always Cheats. And, thus their points start falling. In the next move, 2 always cheats are removed, and 1 Always Cooperate is also removed. Next onwards Copycat begins to Dominate. Thus making it the winner for larger cases.",
		3:"Grudger 9, Cheater: 9 , Cooperator: 7<br>No of rounds per match: 10 <br>Payoffs: default. <br>After the first match, cooperator is exploited the most and hence three of them are eliminated leading to increase in the no of grudgers. Decrease in no of cooperators reduce the points gain of cheaters whereas mutual cooperation between cooperators and grudgers increases the points of cooperators at a significant rate making the result of the given case as: <br>Grudger> Cooperator>Cheater",
		4:"Let’s have some maths<br> Given number of rounds =10, and the guys being Always Cheat, Grudger, and Copycats. Eliminate 1 guy per match. We need to find the minimum sum of Copycats and grudgers such that the system gradually stabilises. <br>Students need to figure out that grugers and copycats eventually behave same after 1st move. So let’s conider x guys and 25-x guys will be always cheat. Now, mathematically, if always cheat must lose then,<br>3x < -(25-x) + (x-1)*2 + 9(x-1)*2 <br>X > 45/18; <br>And the least possible x will be 3. Thus 2 answers : 1 CP 2 Grudger <br>2 Grudger 1 CP…",
		5:"Copy cat:1 Simpleton: 3, detective 15, copykitten: 6 <br>1st step of all the characters is same, thus everyone has a score of 48. <br> 2nd step benefits detective allowing it to take lead.<br>In the next round copycat and simpleton cheats exploiting detective . In further rounds copykitten is the least scorer. Detective becomes cheater for simpleton and copycat after his 1st four steps. Simpleton gets alternate -1 points on its move making it the second least scorer.Copy cat keep getting points from simpleton hence leading.<br>Copy cat>Detective>Simpleton>Copy Kitten ",
		6:"Not applicable",
		7:"Not applicable",
		8:"Students need to figure out that Grugers and Copycats eventually behave same after 1st move. So let’s conider x guys and 25-x guys will be always cheat.<br> Now, mathematically, if always cheat must lose then<br>3x < -(25-x) + (x-1)*2 + 9(x-1)*2<br> X > 45/18;<br>And the least possible x will be 3.<br>Thus<br>2 answers : <strong>1.CP 2.Grudger</strong>",
		9:"Hit and Trial",
	};
